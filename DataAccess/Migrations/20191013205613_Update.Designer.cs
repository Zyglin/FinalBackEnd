...
namespace DataAccess.Migrations
{
    ...
    [Migration("20191013205613_Update")]
            ...
            modelBuilder.Entity("WebFilms.DataAccess.Entity.Film", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("3300428b-833a-484f-87a5-5d9b5e3b1f58"), Description = "The surviving Resistance faces the First Order once more in the final chapter of the Skywalker saga.", GenreId = 3, ImageXPath = "https://m.media-amazon.com/images/M/MV5BZWU1NDI3YjEtZTlmMy00Y2FmLWI1ZDYtMjYwNDUxYTdlODllXkEyXkFqcGdeQXVyODkzNTgxMDg@._V1_SY1000_CR0,0,675,1000_AL_.jpg", Name = "Star Wars", YoutubeId = "Q1qZ6oLV3hg" },
                        new { Id = new Guid("53de3625-fe00-4f01-beaa-37a80f4a9b4e"), Description = "The lives of guards on Death Row are affected by one of their charges: a black man accused of child murder and rape, yet who has a mysterious gift.", GenreId = 1, ImageXPath = "https://m.media-amazon.com/images/M/MV5BMTUxMzQyNjA5MF5BMl5BanBnXkFtZTYwOTU2NTY3._V1_.jpg", Name = "The Green Mile", YoutubeId = "CmxArNBJHFQ" },
                        new { Id = new Guid("91f6aead-36c5-4965-8f9d-c0bdbd1b8568"), Description = "While Frodo and Sam edge closer to Mordor with the help of the shifty Gollum, the divided fellowship makes a stand against Sauron's new ally, Saruman, and his hordes of Isengard.", GenreId = 1, ImageXPath = "https://m.media-amazon.com/images/M/MV5BMDFkYTc0MGEtZmNhMC00ZDIzLWFmNTEtODM1ZmRlYWMwMWFmXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_.jpg", Name = "The Shawshank Redemption", YoutubeId = "6hB3S9bIaco" },
                        new { Id = new Guid("df2f9472-f83d-4bd0-b02d-af35b6014f5c"), Description = "The lives of two mob hitmen, a boxer, a gangster and his wife, and a pair of diner bandits intertwine in four tales of violence and redemption.", GenreId = 1, ImageXPath = "https://m.media-amazon.com/images/M/MV5BNGNhMDIzZTUtNTBlZi00MTRlLWFjM2ItYzViMjE3YzI5MjljXkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_SY1000_CR0,0,686,1000_AL_.jpg", Name = "Pulp Fiction", YoutubeId = "Y6YBKdmOlM8" },
                        new { Id = new Guid("2a8fd98b-8178-4357-9fb5-22cc6396fdee"), Description = "The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.", GenreId = 1, ImageXPath = "https://m.media-amazon.com/images/M/MV5BM2MyNjYxNmUtYTAwNi00MTYxLWJmNWYtYzZlODY3ZTk3OTFlXkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_SY1000_CR0,0,704,1000_AL_.jpg", Name = "The GodFather", YoutubeId = "sY1S34973zA" },
                        new { Id = new Guid("3eb63e6e-c5fe-4196-845f-5cc372362a8a"), Description = "A meek Hobbit from the Shire and eight companions set out on a journey to destroy the powerful One Ring and save Middle-earth from the Dark Lord Sauron.", GenreId = 3, ImageXPath = "https://m.media-amazon.com/images/M/MV5BNGE5MzIyNTAtNWFlMC00NDA2LWJiMjItMjc4Yjg1OWM5NzhhXkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_SY1000_CR0,0,684,1000_AL_.jpg", Name = "The Lord of the Rings", YoutubeId = "r5X-hFf6Bwo" }
                    );
                });
